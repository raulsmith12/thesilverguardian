...
export const unitedStatesServiceAreaContent: Record<Locale, MontrealPageContent> = {
  en: {
    ...
    sections: [
      ...
      ], bullets: ["Kid-friendly research environments in Seattle", "Movement Therapy Centers in Seattle"] },
  ...
  "fr-CA": {
    ...
    sections: [
      ...
      ], bullets: ["Milieux de recherche adaptés aux enfants à Seattle", "Centres de thérapie par le mouvement à Seattle"] },
