  ...
  "movement-therapy": {
    en: {
      ...
      faqs: [
        ...
        { question: "Would participants need to be athletes?", answer: "No. A responsible movement program should adapt activities to different abilities, energy levels and interests rather than require an athletic background." },
    ...
    "fr-CA": {
      ...
      faqs: [
        ...
        { question: "Faudrait-il être athlète pour participer?", answer: "Non. Un programme responsable devrait adapter les activités aux capacités, à l’énergie et aux intérêts plutôt qu’exiger une expérience sportive." },
