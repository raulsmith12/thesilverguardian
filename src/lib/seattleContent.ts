...
const seattleLinks = (locale: Locale): MontrealPageContent["relatedLinks"] => locale === "fr-CA"
  ? [
      ...
      { href: "/seattle/kid-friendly-research-hospitals/", label: "hôpitaux de recherche adaptés aux enfants à Seattle", description: "Explorez une vision prudente de milieux pédiatriques inspirés du hockey sur glace et dirigés par des fournisseurs volontaires." },
      { href: "/seattle/movement-therapy-centers/", label: "centres de thérapie par le mouvement à Seattle", description: "Découvrez un concept communautaire accessible axé sur le mouvement artistique, adapté et inspiré du hockey sur glace." },
    ]
  : [
      { href: "/seattle/", label: "Seattle service-area hub", description: "Return to the overview of Seattle resources and their boundaries." },
      { href: "/seattle/kid-friendly-research-hospitals/", label: "kid-friendly research hospitals in Seattle", description: "Explore a careful vision for provider-led pediatric environments inspired by ice hockey." },
      { href: "/seattle/movement-therapy-centers/", label: "Movement Therapy Centers in Seattle", description: "Explore an accessible community concept for artistic, adapted and ice-hockey-inspired movement." },
    ];
...
export const seattleLandingContent: Record<Locale, MontrealPageContent> = {
  en: {
    ...
    supportingImageAssets: [
      { src: pediatricEnvironmentHero, alt: "Welcoming provider-designed pediatric family lounge with accessible seating and subtle ice-hockey-inspired details" },
  ...
  "fr-CA": {
    ...
    supportingImageAssets: [
      { src: pediatricEnvironmentHero, alt: "Salon familial pédiatrique accessible, conçu par un fournisseur et subtilement inspiré du hockey sur glace" },
...
export function getSeattleTopicContent(slug: string, locale: Locale): MontrealPageContent | undefined {
  ...
  return {
    ...
    description: isHospital
      ? (isFrench ? "Découvrez une vision prudente de milieux de recherche pédiatrique à Seattle, conçus avec des fournisseurs volontaires et inspirés du hockey sur glace." : "Explore a careful vision for kid-friendly research hospital environments in Seattle shaped with willing providers and inspired by ice hockey.")
    ...
    keywords: isHospital
      ? (isFrench ? ["hôpitaux de recherche adaptés aux enfants Seattle", "milieu pédiatrique Seattle", "hôpital inspiré du hockey sur glace Seattle"] : ["kid-friendly research hospitals Seattle", "children's research hospital Seattle", "ice-hockey-themed pediatric environment Seattle"])
