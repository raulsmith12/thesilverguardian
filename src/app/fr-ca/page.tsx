...
const callouts = [
  ...
  { title: "32 souhaits dans 32 villes", text: "Chaque année, l’un de nos objectifs est de réaliser 32 souhaits liés au hockey pour de courageux enfants dans 32 villes aux États-Unis et au Canada.", url: "/fr-ca/32-wishes/", image: wishesImage, alt: "Illustration d’un joueur de hockey sur glace maniant une rondelle sur une glace fracturée" },
      ...
      <main className="flex-1">
        ...
        <section className="publication-feature" aria-labelledby="publication-feature-title">
          <div className="publication-feature__inner">
            ...
            >
              Voir la présentation de l’initiative <span aria-hidden="true">↗</span>
            </a>
          </div>
        </section>
          ...
          <div className="feature-callout-list">
            {callouts.map(({ title, text, url, image, alt }) => (
              <div key={title} className="feature-callout"><div className="feature-callout__inner">
                <div className="feature-callout__image" style={{ position: "relative" }}><Image src={image} alt={alt} fill placeholder="blur" sizes="(max-width: 767px) calc(100vw - 3rem), 22rem" unoptimized /></div>
