...
const cityAliases = {
  ...
  Newark: ["newark", "new jersey", "new jersey devils", "devils"],
  ...
  Raleigh: ["raleigh", "carolina", "carolina hurricanes", "hurricanes", "canes"],
  "Salt Lake City": ["salt lake city", "salt lake", "utah", "utah mammoth", "mammoth", "utah hockey club"],
  ...
  "St. Paul": ["st paul", "st. paul", "minnesota", "minnesota wild", "wild"],
  Sunrise: ["sunrise", "florida", "florida panthers", "panthers"],
  ...
  Washington: ["washington", "washington capitals", "capitals", "caps"],
